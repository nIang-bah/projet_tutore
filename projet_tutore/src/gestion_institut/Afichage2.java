...
public class Afichage2 extends JFrame
{ 
	/**
	 * 
	 */
	...
	public Afichage2() throws SQLException{
       ...
       // java.sql.Statement req = connection.createStatement();
	    ...
	    try
	    {
	        ...
	        ResultSet rs = st.executeQuery( "SELECT idetud as Id_etudiant,prenometu as Prenom_Etudiant,nometu as Nom_Etudiant,dept as Departement,niveau as Niveau FROM etudiant" );
	        ...
	        final JFrame mainFrame = new JFrame( "Liste des etudiants " );
	        ...
	        JButton payer = new JButton("Ajouter un etudiant");
	        ...
	        comptabilite.addActionListener(new ActionListener(){
		          public void actionPerformed(ActionEvent arg0) {
